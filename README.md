...
A real-time browser-based guitar training game built with **React**, **Phaser**, and **Pitch Detection**.

This project combines my passion for **guitar** with my academic interest in **software development and interactive systems**.
...
The game detects pitch in real-time and shoots targets when the correct note is played.
...
Instead of creating a traditional web application, I wanted to build something more creative, interactive, and personally meaningful.
...
- Music-based learning systems

Guitar Note Shooter is both a fun arcade-style game and an experimental ear-training platform that blends technology with music.
